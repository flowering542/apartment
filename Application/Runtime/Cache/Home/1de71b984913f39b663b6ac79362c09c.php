...
<div class="container_wrapper clearfix">
	...
	<div class="leftContent" style="padding-left: 10px;position: relative;">
		...
		<?php if(!empty($list)): ?><ul class="pagination" id="page1">
			 <?php if($page > 1): ?><li>
		            <a href="<?php echo U('Index/otherList1',array('page'=>$page-1));?>">
		              «
		            </a>
		        </li>
		        <?php else: ?>
		        <li><a href="javascript:void(0)" class="btn" disabled="disabled">«</a></li><?php endif; ?>
            <?php $__FOR_START_8058__=1;$__FOR_END_8058__=$pageCount+1;for($i=$__FOR_START_8058__;$i < $__FOR_END_8058__;$i+=1){ ?><li><a href='<?php echo U("Index/otherList1?page=$i");?>'><?php echo ($i); ?></a></li>
                <?php if($i >= 20): ?><li><a href='#'>...</a></li>
                   <?php break; endif; } ?>
          <?php if($page < $pageCount): ?><li>
                    <a href="<?php echo U('Index/otherList1',array('page'=>$page+1));?>">»</a>
                </li>
                <?php else: ?>
	...
	<div class="sidebarRight fr" style="margin-right: 10px;">
		...
		<div class="content">
			...
			<p style="font-size: 20px;" class="mt_20">榴园226</p>
			<p style="font-size: 20px;color: rgb(255, 204, 0);" class="mt_20"><i class="fa fa-qq"></i>QQ</p>
			<p style="font-size: 20px;" class="mt_20">761654554</p>
		</div>
	</div>
</div>
