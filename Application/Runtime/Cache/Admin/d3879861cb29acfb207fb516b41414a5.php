    ...
    <div class="pagin">
        ...
        <?php if(!empty($list)): ?><ul class="paginList">
                 <?php if($page > 1): ?><li class="paginItem">
                        <a href="<?php echo U('Article/xszt',array('page'=>$page-1));?>">
                            <span class="pagepre"></span>
                        </a>
                    </li>
                    <?php else: ?>
                    <li class="paginItem"><a href="#" disabled="disabled"> <span class="pagepre"></span></a></li><?php endif; ?>
                 <?php $__FOR_START_22684__=1;$__FOR_END_22684__=$pageCount+1;for($i=$__FOR_START_22684__;$i < $__FOR_END_22684__;$i+=1){ ?><li class="paginItem"><a href='<?php echo U("Article/xszt?page=$i");?>'><?php echo ($i); ?></a></li>
                    <?php if($i >= 20): ?><li class="paginItem more"><a href='#'>...</a></li>
                       <?php break; endif; } ?>
                 <?php if($page < $pageCount): ?><li class="paginItem">
                        <a href="<?php echo U('Article/xszt',array('page'=>$page+1));?>"><span class="pagenxt"></span></a>
                    </li>
                    <?php else: ?>
